...
const AdminChat = () => {
  ...
  const [newChatType, setNewChatType] = useState("VENDOR");
  ...
  const handleStartChat = useCallback(async () => {
    ...
    try {
      ...
      const freshRes = await getConversations(activeTab);
  ...
  }, [newChatId, fetchConversations, selectConversation, activeTab, scrollToBottom, joinConversation]);
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              <Label className="text-sm">
                {newChatType === "VENDOR" ? "Vendor ID" : "User ID"}
              </Label>
              <Input
                placeholder={
                  newChatType === "VENDOR"
                    ? "Enter Vendor ID (e.g. VND-8F42K7)"
                    : "Enter User ID (e.g. USR-4P91XZ)"
                }
                value={newChatId}
                onChange={(e) => {
