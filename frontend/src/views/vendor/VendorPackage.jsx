...
const VendorPackage = () => {
  ...
  const fetchPackage = useCallback(async (showLoader = false) => {
    try {
      ...
      setError("");
      const res = await api.get("/vendor/package");
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Your vendor subscription package details.</p>
      </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Complete access to the Local Printer vendor platform</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <Button className="w-full" size="lg" disabled>
                Pay &#8377;{(appliedCoupon ? appliedCoupon.finalPrice : originalPrice).toLocaleString("en-IN")} & Register
              </Button>
